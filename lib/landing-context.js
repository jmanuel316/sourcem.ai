 ...
 *   abVariant:        A/B test variant assigned to this page render ('a' or 'b').
 *
...
function buildLandingContext(req) {
  ...
  // Accept variant override from URL param ?v=a|b.
  // Caller handles assignment logic before calling.
  const abVariant = req?.query?.v || null;
  return {
    slug,
    theme: {},
